...
|`account_locked_verification_required`| The retailer emailed you a code which you must supply to continue ordering. [More Info](/api-reference/appendix/amazon-email-verification) |
...
|`invalid_address`                     | The provided address was incomplete or could not be parsed. Try providing an address in [canonical Zinc format](/object-reference/address) rather than free-form text.|
...
|`unknown_retailer`                    | The provided product URLs did not correspond to a known [supported retailer](/supported-retailers).               |
